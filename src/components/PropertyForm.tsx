      ...
      <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, onInvalid)} className="space-y-10">
          ...
          <section className="p-6 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="address_hidden">Dirección Exacta (Calle y Número)</Label>
                <Input id="address_hidden" {...form.register("address_hidden")} placeholder="Ej. Calle Juan Sebastián Elcano, 4" />
                {form.formState.errors.address_hidden && <p className="text-sm text-red-500">{form.formState.errors.address_hidden.message}</p>}
              </div>
              <div className="space-y-2">
                <Label htmlFor="address_public">Zona/Barrio Público</Label>
                <Input id="address_public" {...form.register("address_public")} placeholder="Ej. Campo Grande" />
              ...
              <div className="space-y-2">
                ...
                <Input id="city" {...form.register("city")} placeholder="Ej. Valladolid" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="province">Provincia</Label>
                <Input id="province" {...form.register("province")} placeholder="Ej. Valladolid" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="zipcode">Código Postal</Label>
                <Input id="zipcode" {...form.register("zipcode")} placeholder="Ej. 47006" />
              </div>
              <div className="space-y-2">
          ...
          <section className="bg-gray-50/50 p-6 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="area_built">M² Construidos</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="area_useful">M² Útiles</Label>
          ...
          <section className="p-6 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="energy_consumption">Consumo de energía (kwh/m2 año)</Label>
                <Input id="energy_consumption" type="number" {...form.register("energy_consumption", { valueAsNumber: true })} />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="emissions">Emisiones (kg CO / m2 año)</Label>
                <Input id="emissions" type="number" {...form.register("emissions", { valueAsNumber: true })} />
              </div>
            </div>
          </section>
          ...
          <section className="p-6 border border-gray-100 rounded-xl">
             ...
             <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="title" {...form.register("title")} placeholder="Ej. Espectacular ático con vistas..." />
                ...
                <div className="space-y-2">
                  ...
                  <textarea id="description" {...form.register("description")} className="flex min-h-[160px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm" />
