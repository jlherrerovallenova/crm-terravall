...
export const rentalContractSchema = z.object({
  ...
  ownerEmail: z.union([z.email({ message: "Email del propietario no válido" }), z.literal("")]).optional(),
  tenantEmail: z.union([z.email({ message: "Email del inquilino no válido" }), z.literal("")]).optional(),
