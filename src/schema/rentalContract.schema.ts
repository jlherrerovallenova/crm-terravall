...
export const rentalContractSchema = z.object({
  ...
  ownerEmail: z.string().email({ message: "Email del propietario no válido" }).optional().or(z.literal("")),
  tenantEmail: z.string().email({ message: "Email del inquilino no válido" }).optional().or(z.literal("")),
