...
const basePropertySchema = z.object({
  ...
  // Datos Internos
  website_url: z.union([z.string().url({ message: "La URL no es válida" }), z.literal("")]).optional(),
  ...
  owner_dni: z.string().nullable().optional(),
  owner_civil_status: z.enum(["soltero", "casado", "pareja_de_hecho", "divorciado", "separado", "viudo"]).nullable().optional().default("soltero"),
  owner_matrimonial_regime: z.enum(["gananciales", "separacion_bienes", "participacion"]).nullable().optional().default("gananciales"),
  owner_address: z.string().nullable().optional(),
  owner_street: z.string().nullable().optional(),
  owner_number: z.string().nullable().optional(),
  owner_floor_letter: z.string().nullable().optional(),
  owner_city: z.string().nullable().optional(),
  owner_zipcode: z.string().nullable().optional(),
  owner_province: z.string().nullable().optional(),
  owner_phone: z.string().nullable().optional(),
  owner_email: z.string().nullable().optional(),
  has_owner2: z.boolean().nullable().optional().default(false),
  owner2_name: z.string().nullable().optional(),
  owner2_dni: z.string().nullable().optional(),
  owner2_civil_status: z.enum(["soltero", "casado", "pareja_de_hecho", "divorciado", "separado", "viudo"]).nullable().optional().default("soltero"),
  owner2_matrimonial_regime: z.enum(["gananciales", "separacion_bienes", "participacion"]).nullable().optional().default("gananciales"),
  owner2_address: z.string().nullable().optional(),
  owner2_street: z.string().nullable().optional(),
  owner2_number: z.string().nullable().optional(),
  owner2_floor_letter: z.string().nullable().optional(),
  owner2_city: z.string().nullable().optional(),
  owner2_province: z.string().nullable().optional(),
  owner2_zipcode: z.string().nullable().optional(),
  seller2_same_address: z.boolean().nullable().optional().default(true),
  owners_relationship: z.enum(["ninguna", "casados_entre_si", "pareja_hecho_entre_si"]).nullable().optional().default("ninguna"),
  ...
  buyer1_name: z.string().nullable().optional(),
  buyer1_dni: z.string().nullable().optional(),
  buyer1_civil_status: z.enum(["soltero", "casado", "pareja_de_hecho", "divorciado", "separado", "viudo"]).nullable().optional().default("soltero"),
  buyer1_matrimonial_regime: z.enum(["gananciales", "separacion_bienes", "participacion"]).nullable().optional().default("gananciales"),
  buyer1_address: z.string().nullable().optional(),
  buyer1_street: z.string().nullable().optional(),
  buyer1_number: z.string().nullable().optional(),
  buyer1_floor_letter: z.string().nullable().optional(),
  buyer1_city: z.string().nullable().optional(),
  buyer1_province: z.string().nullable().optional(),
  buyer1_zipcode: z.string().nullable().optional(),
  has_buyer2: z.boolean().nullable().optional().default(false),
  buyer2_name: z.string().nullable().optional(),
  buyer2_dni: z.string().nullable().optional(),
  buyer2_civil_status: z.enum(["soltero", "casado", "pareja_de_hecho", "divorciado", "separado", "viudo"]).nullable().optional().default("soltero"),
  buyer2_matrimonial_regime: z.enum(["gananciales", "separacion_bienes", "participacion"]).nullable().optional().default("gananciales"),
  buyer2_address: z.string().nullable().optional(),
  buyer2_street: z.string().nullable().optional(),
  buyer2_number: z.string().nullable().optional(),
  buyer2_floor_letter: z.string().nullable().optional(),
  buyer2_city: z.string().nullable().optional(),
  buyer2_province: z.string().nullable().optional(),
  buyer2_zipcode: z.string().nullable().optional(),
  buyer2_same_address: z.boolean().nullable().optional().default(true),
  buyers_relationship: z.enum(["ninguna", "casados_entre_si", "pareja_hecho_entre_si"]).nullable().optional().default("ninguna"),

  // Datos Adicionales del Contrato de Arras
  seller_iban: z.string().nullable().optional(),
  notary_deadline: z.string().nullable().optional(),
  jurisdiction_city: z.string().nullable().optional(),
  arras_amount_num: z.number().nullable().optional(),
  cru: z.string().nullable().optional(),
  cadastral_reference: z.string().nullable().optional(),
  charges_option: z.string().nullable().optional(),
  retention_amount: z.string().nullable().optional(),
  return_days: z.string().nullable().optional(),
  management_months: z.string().nullable().optional(),
  include_kitchen_clause: z.boolean().nullable().optional(),
  include_furniture_clause: z.boolean().nullable().optional(),
  furniture_description: z.string().nullable().optional(),
  include_photo_report_clause: z.boolean().nullable().optional(),
  include_mortgage_suspensive_clause: z.boolean().nullable().optional(),
  mortgage_days: z.string().nullable().optional(),
