...
const basePropertySchema = z.object({
  ...
  owner2_matrimonial_regime: z.enum(["gananciales", "separacion_bienes", "participacion"]).optional().default("gananciales"),
  owner2_address: z.string().optional(),
  owner2_street: z.string().optional(),
  owner2_number: z.string().optional(),
  owner2_floor_letter: z.string().optional(),
  owner2_city: z.string().optional(),
  owner2_province: z.string().optional(),
  owner2_zipcode: z.string().optional(),
  seller2_same_address: z.boolean().optional().default(true),
  ...
  buyer2_address: z.string().optional(),
  buyer2_street: z.string().optional(),
  buyer2_number: z.string().optional(),
  buyer2_floor_letter: z.string().optional(),
  buyer2_city: z.string().optional(),
  buyer2_province: z.string().optional(),
  buyer2_zipcode: z.string().optional(),
  buyer2_same_address: z.boolean().optional().default(true),
  ...
  charges_option: z.string().optional(),
  retention_amount: z.string().optional(),
  return_days: z.string().optional(),
  management_months: z.string().optional(),
  include_kitchen_clause: z.boolean().optional(),
  include_furniture_clause: z.boolean().optional(),
  furniture_description: z.string().optional(),
  include_photo_report_clause: z.boolean().optional(),
  include_mortgage_suspensive_clause: z.boolean().optional(),
  mortgage_days: z.string().optional(),
  mortgage_amount: z.string().optional(),
